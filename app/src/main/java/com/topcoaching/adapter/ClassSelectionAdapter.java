...
public class ClassSelectionAdapter extends RecyclerView.Adapter<ClassSelectionAdapter.CommonViewModel> {
    ...
    public ClassSelectionAdapter(Context context, List<AppModel> items, Response.OnClickListener<AppModel> callback) {
